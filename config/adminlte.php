...
return [
    ...
    */
    ...
    'title' => 'Alas Chiquitanas',
    'title_prefix' => '',
    'title_postfix' => ' - Sistema Bomberos',
    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text' => 'Niveles de Entrenamiento',
                    'url' => 'niveles-entrenamiento',
                    'icon' => 'fas fa-fw fa-graduation-cap',
                ],
                [
                    'text' => 'Niveles de Gravedad',
                    'url' => 'niveles-gravedad',
    ...
    */
    ...
    'filters' => [
        ...
        App\Menu\Filters\ReportesPendientesFilter::class, // Filtro para badge de reportes pendientes
    ],
        ...
        'CustomMenuIndicator' => [
            ...
            'files' => [
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'css/menu-indicator.css',
                ],
            ],
        ],
    ],

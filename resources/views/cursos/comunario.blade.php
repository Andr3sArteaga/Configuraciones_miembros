...
@section('title', 'Cursos del Comunario')

@section('content_header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Cursos del Comunario</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('home') }}">Inicio</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('equipos.index') }}">Equipos</a></li>
                    <li class="breadcrumb-item active">Cursos Comunario</li>
                </ol>
            </div>
        </div>
    </div>
...
@section('content')
    <div class="container-fluid">
            ...
            <div class="col-md-12">
                <div class="card card-success">
                    <div class="card-header">
                        <h3 class="card-title">
                            <i class="fas fa-user-friends"></i> {{ $comunario->nombre }}
                        </h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <p><strong>Edad:</strong> {{ $comunario->edad ?? 'N/A' }}</p>
                                <p><strong>Entidad Perteneciente:</strong>
                                    {{ $comunario->entidad_perteneciente ?? 'N/A' }}</p>
                            </div>
                            <div class="col-md-6">
                                <p><strong>Equipo:</strong>
                                    @if ($comunario->equipo)
                                        <a
                                            href="{{ route('equipos.show', $comunario->equipo->id) }}">{{ $comunario->equipo->nombre_equipo }}</a>
                                    @else
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center">
                                            <p class="text-muted">Este comunario no tiene cursos asignados.</p>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
        ...
        <div class="row">
            <div class="col-md-12">
                @if ($comunario->equipo)
                    <a href="{{ route('equipos.show', $comunario->equipo->id) }}" class="btn btn-secondary">

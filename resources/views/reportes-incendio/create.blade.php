...
@section('title', 'Nuevo Reporte de Incendio')

@section('content_header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Nuevo Reporte de Incendio</h1>
            </div>
            <div class="col-sm-6">
...
@section('content')
    <div class="container-fluid">
        <form action="{{ route('reportes-incendio.store') }}" method="POST">
            @csrf
            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" type="checkbox" id="necesita_mas_bomberos"
                                                ...
                                                {{ old('necesita_mas_bomberos') ? 'checked' : '' }}>
                    ...
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            <p class="text-sm">
                                ...
                                <strong>Campos obligatorios:</strong> Solo el nombre del incidente es obligatorio.
                            </p>
                            <p class="text-sm">
                                <i class="fas fa-user text-primary mr-1"></i>
                                <strong>Reportado por:</strong> El reporte se creará a nombre del usuario actual.
                            </p>
                            <p class="text-sm">
                                <i class="fas fa-calendar text-success mr-1"></i>
                                <strong>Fecha:</strong> Se registrará automáticamente la fecha y hora actual.
                            </p>
                            <p class="text-sm">
                                <i class="fas fa-fire-extinguisher text-danger mr-1"></i>
                                <strong>Estado:</strong> El incendio se marcará como "No controlado" inicialmente.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save mr-1"></i> Guardar Reporte
                            </button>
